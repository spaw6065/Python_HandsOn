# Alice and Bob each created one problem. A reviewer rates the two challenges,
...
# The return list is [1, 1] with Alice's score first and Bob's second.
#
...
def compareTriplets(a, b):
    ...
    for a_elem in a:
        for b_elem in b[a.index(a_elem):a.index(a_elem)+1]:
            #print(a_elem,b_elem)
            if a_elem > b_elem:
                Points_Alice += 1
            elif a_elem < b_elem:
    ...
    #prepare a list and append the points Alice first and then Bob
